...
namespace Microsoft.IIoT.Protocols.OpcUa.Publisher.Handlers {
    ...
    /// </summary>
    public sealed class NetworkMessageUadpHandler : ITelemetryHandler {
        ...
        public async Task HandleAsync(string source, byte[] payload,
            ...
            try {
                ...
                using var decoder = new BinaryDecoder(new MemoryStream(payload), context);
