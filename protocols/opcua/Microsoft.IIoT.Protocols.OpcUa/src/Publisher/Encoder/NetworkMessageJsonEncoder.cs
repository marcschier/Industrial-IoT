...
namespace Microsoft.IIoT.Protocols.OpcUa.Publisher.Services {
    ...
    /// </summary>
    public class NetworkMessageJsonEncoder : INetworkMessageEncoder {
        ...
        private IEnumerable<NetworkMessage> GetNetworkMessages(string writerGroupId,
            ...
            foreach (var message in messages) {
                var networkMessage = new NetworkMessage {
                    MessageContentMask = contentMask.ToStackType(NetworkMessageEncoding.Json),
                ...
                while (notificationQueues.Where(q => q.Any()).Any()) {
                    ...
                    var dataSetMessage = new DataSetMessage(
                        ...
                        MessageContentMask = (message.Writer?.MessageSettings?.DataSetMessageContentMask)
                            .ToStackType(NetworkMessageEncoding.Json),
