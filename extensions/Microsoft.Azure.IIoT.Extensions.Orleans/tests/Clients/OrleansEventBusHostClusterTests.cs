...
namespace Microsoft.Azure.IIoT.Extensions.Orleans.Clients {
    ...
    public class OrleansEventBusHostClusterTests : IClassFixture<OrleansEventBusFixture> {
        private readonly OrleansEventBusFixture _fixture;

        public OrleansEventBusHostClusterTests(OrleansEventBusFixture fixture) {
            _fixture = fixture;
        }
