...
namespace Microsoft.IIoT.Extensions.Orleans.Clients {
    ...
    public class OrleansEventBusHostClusterTests : IClassFixture<OrleansClusterEventBusFixture> {
        private readonly OrleansClusterEventBusFixture _fixture;

        public OrleansEventBusHostClusterTests(OrleansClusterEventBusFixture fixture) {
            _fixture = fixture;
        }
