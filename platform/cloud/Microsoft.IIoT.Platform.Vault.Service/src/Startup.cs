...
namespace Microsoft.IIoT.Platform.Vault.Service {
    using Microsoft.IIoT.Platform.Vault.Events;
    using Microsoft.IIoT.Platform.Vault.Handler;
    using Microsoft.IIoT.Platform.Vault.Services;
    using Microsoft.IIoT.Platform.Vault.Storage;
    using Microsoft.IIoT.Platform.Discovery.Api.Clients;
    using Microsoft.IIoT.Platform.Discovery.Events.v2;
    ...
    using Microsoft.IIoT.Extensions.Crypto.Runtime;
    ...
    public class Startup {
        ...
        public virtual void ConfigureContainer(ContainerBuilder builder) {
            ...
            builder.RegisterType<CertificateRevoker>()
                .AsImplementedInterfaces().SingleInstance();
            builder.RegisterType<CertificateFactoryConfig>()
                .AsImplementedInterfaces();
