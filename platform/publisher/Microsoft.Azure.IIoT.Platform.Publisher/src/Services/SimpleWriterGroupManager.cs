...
namespace Microsoft.Azure.IIoT.Platform.Publisher.Services {
    ...
    /// This encapsulates the work that happens between control and data plane, 
    /// where the notifications change the twin state and cause the reconfiguration
    /// of the data plane here.
    /// </summary>
    public sealed class SimpleWriterGroupManager : IWriterGroupRegistryListener,
        IDataSetWriterRegistryListener, IDisposable {
        ...
        public SimpleWriterGroupManager(IDataSetWriterRegistry registry,
            ...
            _writerGroupEvents = writerGroupEvents.Register(this);
            _dataSetWriterEvents = dataSetWriterEvents.Register(this);
        }

        /// <inheritdoc/>
        public async Task OnDataSetWriterAddedAsync(OperationContextModel context,
        ...
        /// <inheritdoc/>
        public async Task OnDataSetWriterUpdatedAsync(OperationContextModel context,
            string dataSetWriterId, DataSetWriterInfoModel dataSetWriter) {
        ...
        /// <inheritdoc/>
        public void Dispose() {
            _writerGroupEvents.Invoke();
            _dataSetWriterEvents.Invoke();
        }
        ...
        private readonly Action _writerGroupEvents;
        private readonly Action _dataSetWriterEvents;
    }
}
