...
namespace Microsoft.Azure.IIoT.Platform.Publisher.Edge.Engine {
    ...
    public class LegacyJobOrchestrator : IJobOrchestrator {
        ...
        public LegacyJobOrchestrator(PublishedNodesFile publishedNodesJobConverter,
                ...
                try {
                    ...
                    if (currentFileHash != _lastKnownFileHash) {
                        ...
                        using (var reader = new StreamReader(_legacyCliModel.PublishedNodesFile)) {
                            var writerGroup = _publishedNodesJobConverter.Read(reader);
                                var job = new WriterGroupJobModel { WriterGroup = writerGroup };
                                var jobId = $"Standalone_{_identity.DeviceId}_{_identity.ModuleId}";
                                writerGroup.DataSetWriters.ForEach(d => {
        ...
        private readonly PublishedNodesFile _publishedNodesJobConverter;
