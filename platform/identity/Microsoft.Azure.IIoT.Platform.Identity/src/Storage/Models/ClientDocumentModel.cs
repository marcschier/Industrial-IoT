...
namespace Microsoft.Azure.IIoT.Platform.Identity.Models {
    ...
    public class ClientDocumentModel {
        ...
        /// <summary>
        /// Specifies whether the client must use a request
        /// object on authorize requests (defaults to false.)
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Signing algorithm for identity token. If empty,
        ...
        /// <summary>
        /// The maximum duration (in seconds) since the last time
