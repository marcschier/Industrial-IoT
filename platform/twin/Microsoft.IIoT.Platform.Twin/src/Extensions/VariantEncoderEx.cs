...
namespace Microsoft.IIoT.Platform.OpcUa {
    ...
    public static class VariantEncoderEx {
        ...
        /// <returns></returns>
        public static VariantValue Encode(this IVariantEncoder codec,
            DeleteEventsDetailsModel details) {
            if (details == null) {
                throw new ArgumentNullException(nameof(details));
            }
        ...
        /// <returns></returns>
        public static VariantValue Encode(this IVariantEncoder codec,
            DeleteModifiedValuesDetailsModel details) {
            if (codec is null) {
                throw new ArgumentNullException(nameof(codec));
            }
            if (details == null) {
        ...
        /// <returns></returns>
        public static VariantValue Encode(this IVariantEncoder codec,
            ReadValuesAtTimesDetailsModel details) {
            if (codec is null) {
                throw new ArgumentNullException(nameof(codec));
            }
            if (details == null) {
        ...
        /// <returns></returns>
        public static HistoricValueModel[] DecodeValues(this IVariantEncoder codec,
            VariantValue result) {
            if (codec is null) {
                throw new ArgumentNullException(nameof(codec));
            }
