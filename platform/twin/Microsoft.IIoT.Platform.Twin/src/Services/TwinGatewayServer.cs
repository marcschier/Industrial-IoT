...
namespace Microsoft.IIoT.Platform.Twin.Services {
    ...
    /// </summary>
    public sealed class TwinGatewayServer : SessionServerBase, IServer {
        ...
        public TwinGatewayServer(IApplicationRegistry registry, ISessionServices sessions,
        ...
        private async Task InitAsync() {
            var config = new ApplicationConfiguration {
                ...
                ApplicationName = "Microsoft.IIoT.Gateway",
                ...
                SecurityConfiguration = new SecurityConfiguration {
                    ApplicationCertificate = new CertificateIdentifier {
                        ...
                        StorePath = "pki/own",
                        SubjectName = "Microsoft.IIoT.Gateway"
                    },
        ...
        private List<SoftwareCertificate> ValidateClientCertificateChain(
            ...
            if (context.SecurityPolicyUri != SecurityPolicies.None) {
                ...
                if ((context.DiagnosticsMask & DiagnosticsMasks.OperationAll) != 0) {
                    _ = new DiagnosticInfoCollection();
                }
