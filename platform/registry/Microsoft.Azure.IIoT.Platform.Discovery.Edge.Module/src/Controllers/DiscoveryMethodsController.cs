...
namespace Microsoft.Azure.IIoT.Platform.Registry.Edge.Module.Controllers {
    using Microsoft.Azure.IIoT.Platform.Registry.Edge.Module.Filters;
    using Microsoft.Azure.IIoT.Platform.Registry.Edge.Module.Models;
    ...
    public class DiscoveryMethodsController : IMethodController {
        ...
        public DiscoveryMethodsController(IDiscovererServices discover) {
        ...
        private readonly IDiscovererServices _discover;
    }
}
