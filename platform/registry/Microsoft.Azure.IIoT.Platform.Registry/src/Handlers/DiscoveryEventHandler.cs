...
namespace Microsoft.Azure.IIoT.Platform.Registry.Handlers {
    ...
    /// </summary>
    public sealed class DiscoveryEventHandler : ITelemetryHandler {

        /// <inheritdoc/>
        public string MessageSchema => Registry.Models.MessageSchemaTypes.DiscoveryEvents;
        ...
        public DiscoveryEventHandler(IEnumerable<IDiscovererResultProcessor> processors,
        ...
        private readonly List<IDiscovererResultProcessor> _processors;
    }
}
