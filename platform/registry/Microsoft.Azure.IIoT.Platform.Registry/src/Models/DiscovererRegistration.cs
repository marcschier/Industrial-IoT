...
namespace Microsoft.Azure.IIoT.Platform.Registry.Models {
    ...
    public sealed class DiscovererRegistration : EntityRegistration {
        ...
        public override int GetHashCode() {
            ...
            hash.Add(LogLevel);
            hash.Add(Discovery);
            hash.Add(AddressRangesToScan);
            hash.Add(NetworkProbeTimeout);
            hash.Add(MaxNetworkProbes);
            hash.Add(PortRangesToScan);
            hash.Add(PortProbeTimeout);
            hash.Add(MaxPortProbes);
            hash.Add(MinPortProbesPercent);
            hash.Add(SecurityModeFilter);
            hash.Add(IdleTimeBetweenScans);
