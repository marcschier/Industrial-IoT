...
namespace Microsoft.Azure.IIoT.Platform.Directory.Api.Clients {
    ...
    /// </summary>
    public sealed class DirectoryServiceClient : IDirectoryServiceApi {
        ...
        public DirectoryServiceClient(IHttpClient httpClient, IDirectoryConfig config,
        ...
        /// <param name="serializer"></param>
        public DirectoryServiceClient(IHttpClient httpClient, string serviceUri,
