...
namespace Microsoft.Azure.IIoT.Platform.Discovery.Api.Clients {
    ...
    /// </summary>
    public sealed class DiscoveryServicesApiAdapter : IEndpointRegistry,
        ...
        public DiscoveryServicesApiAdapter(IDiscoveryServiceApi client) {
        ...
        private readonly IDiscoveryServiceApi _client;
    }
}
