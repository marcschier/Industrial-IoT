...
namespace Microsoft.Azure.IIoT.Platform.Discovery.Default {
    ...
    public sealed class ApplicationEventBroker :
        IDiscoveryEventBroker<IApplicationRegistryListener>,
        IDiscoveryEvents<IApplicationRegistryListener> {
