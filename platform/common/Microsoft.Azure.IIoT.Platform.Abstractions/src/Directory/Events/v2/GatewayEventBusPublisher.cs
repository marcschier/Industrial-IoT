...
namespace Microsoft.Azure.IIoT.Platform.Directory.Events.v2 {
    ...
    public class GatewayEventBusPublisher : IGatewayRegistryListener {
        ...
        /// <inheritdoc/>
        public Task OnGatewayDeletedAsync(DirectoryOperationContextModel context,
            string gatewayId) {
        ...
        /// <inheritdoc/>
        public Task OnGatewayNewAsync(DirectoryOperationContextModel context,
        ...
        /// <inheritdoc/>
        public Task OnGatewayUpdatedAsync(DirectoryOperationContextModel context,
            GatewayModel gateway) {
        ...
        private static GatewayEventModel Wrap(GatewayEventType type,
            DirectoryOperationContextModel context, string gatewayId,
            GatewayModel gateway) {
