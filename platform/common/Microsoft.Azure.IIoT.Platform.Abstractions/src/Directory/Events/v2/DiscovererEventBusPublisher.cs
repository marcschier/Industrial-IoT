...
namespace Microsoft.Azure.IIoT.Platform.Directory.Events.v2 {
    ...
    public class DiscovererEventBusPublisher : IDiscovererRegistryListener {
        ...
        /// <inheritdoc/>
        public Task OnDiscovererDeletedAsync(DirectoryOperationContextModel context,
            string discovererId) {
        ...
        /// <inheritdoc/>
        public Task OnDiscovererNewAsync(DirectoryOperationContextModel context,
        ...
        /// <inheritdoc/>
        public Task OnDiscovererUpdatedAsync(DirectoryOperationContextModel context,
            DiscovererModel discoverer) {
        ...
        private static DiscovererEventModel Wrap(DiscovererEventType type,
            DirectoryOperationContextModel context, string discovererId,
            DiscovererModel discoverer) {
