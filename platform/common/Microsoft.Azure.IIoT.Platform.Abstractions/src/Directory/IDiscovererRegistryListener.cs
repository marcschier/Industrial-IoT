...
namespace Microsoft.Azure.IIoT.Platform.Directory {
    ...
    public interface IDiscovererRegistryListener {
        ...
        /// <returns></returns>
        Task OnDiscovererNewAsync(DirectoryOperationContextModel context,
        ...
        /// <param name="discoverer"></param>
        /// <returns></returns>
        Task OnDiscovererUpdatedAsync(DirectoryOperationContextModel context,
            DiscovererModel discoverer);
        ...
        /// <returns></returns>
        Task OnDiscovererDeletedAsync(DirectoryOperationContextModel context,
            string discovererId);
    }
}
