...
namespace Microsoft.Azure.IIoT.Utils {
    ...
    /// Run on schedule
    /// </summary>
    public abstract class SchedulerHost : IHostProcess, IDisposable {
        ...
        public SchedulerHost(ILogger logger, string taskName, TimeSpan interval,
        ...
        private class TimerTask : IDisposable {
            ...
            public TimerTask(SchedulerHost outer) {
                _outer = outer;
