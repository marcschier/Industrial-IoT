...
namespace Microsoft.Azure.IIoT.Messaging.Kafka.Runtime {
    ...
    /// </summary>
    public class KafkaConsumerConfig : ConfigBase, IKafkaConsumerConfig {
        ...
        private const string kTopicKey = "Topic";
        ...
        public string ConsumerGroup => GetStringOrDefault(kConsumerGroupKey,
            () => GetStringOrDefault(PcsVariable.PCS_KAFKA_CONSUMERGROUP,
